...
const translations = {
  ...
  'article.hyperthyroid.treatment.text': {
    fi: 'Hoitovaihtoehtoja on neljä. 1) Päivittäinen lääkitys tiamatsolilla (toiselta nimeltään metimatsoli) joko tabletteina (esim. Felimazole) tai oraaliliuoksena (esim. Apelka): suhteellisen edullinen, mutta elinikäinen hoito. Useimmat kissat sietävät lääkettä hyvin. Haittavaikutukset ilmaantuvat yleensä ensimmäisten viikkojen aikana ja harvoin enää kahden tai kolmen kuukauden jälkeen: oksentelu, huono ruokahalu, väsymys tai voimakas pään ja kaulan alueen kutina, joka voi johtaa raapimishaavoihin. Harvoin lääke vaikuttaa maksaan tai verisoluihin, joten ota meihin yhteyttä, jos kissasi alkaa voida huonosti tai sille nousee kuume, sen iho tai limakalvot kellastuvat tai se vuotaa herkästi verta. T4, munuaisarvot ja verenkuva tarkistetaan noin 3, 6, 10 ja 20 viikon kuluttua hoidon aloittamisesta, jokaisen annosmuutoksen jälkeen ja siitä eteenpäin muutaman kuukauden välein. Tiamatsoli voi vaurioittaa sikiötä. Pese kätesi lääkkeen antamisen jälkeen sekä käsiteltyäsi kissanhiekkaa tai kissan oksennusta. Älä puolita äläkä murskaa tabletteja. Hedelmällisessä iässä olevien naisten tulee käyttää kertakäyttökäsineitä antaessaan lääkettä sekä käsitellessään kissanhiekkaa tai oksennusta. Jos olet tai saatat olla raskaana tai suunnittelet raskautta, pyydä jotakuta muuta antamaan lääke ja puhdistamaan hiekkalaatikko. 2) Leikkaus (tyreoidektomia) voi parantaa sairauden. Noin 70 %:lla kissoista sairaus koskee molempia kilpirauhaslohkoja, ja molempien poistaminen voi vaurioittaa viereisiä lisäkilpirauhasia ja laskea veren kalsiumpitoisuutta joko ohimenevästi tai pysyvästi. Kissan tila tasapainotetaan ensin lääkityksellä, koska nukutus on hoitamatonta liikatoimintaa sairastavalle kissalle tavallista riskialttiimpi. 3) Radiojodihoitoa (I-131) pidetään useimmille kissoille ensisijaisena hoitona: yksi hoitokerta parantaa yli 95 % kissoista. Suomessa sitä tarjoaa vain pari erikoistunutta klinikkaa. Kissa on useita päiviä eristyksessä eläinsairaalassa. Sen jälkeen sitä on pidettävä kotona sisällä noin kahden viikon ajan, eivätkä lapset tai raskaana olevat naiset saa olla kosketuksissa siihen. Hoitava klinikka antaa tarkat ohjeet, myös kissan ulosteiden käsittelystä. Ennen leikkausta tai radiojodihoitoa annettava lääkityskokeilu voi auttaa ennakoimaan, miten munuaiset selviävät, kun kilpirauhasen toiminta on saatu hallintaan. 4) Vähäjodinen dieettiruoka (Hill’s y/d): se tehoaa vain, jos kissa ei syö mitään muuta – ei edes herkkuja, muiden lemmikkien ruokaa tai saaliseläimiä – eikä silloinkaan kaikilla kissoilla. Osa kissoista myös kieltäytyy syömästä sitä maun takia. Siksi se sopii lähinnä yhden kissan talouksien sisäkissoille. Autamme sinua valitsemaan kissasi tilanteeseen parhaiten sopivan hoidon.',
    sv: 'Det finns fyra behandlingsalternativ. 1) Daglig medicinering med tiamazol (även kallat metimazol), som tabletter (t.ex. Felimazole) eller oral lösning (t.ex. Apelka): relativt förmånlig, men livslång. De flesta katter tål medicinen bra. Biverkningar uppträder oftast under de första veckorna och sällan efter två till tre månader: kräkningar, dålig aptit, slöhet eller kraftig klåda på huvudet och halsen som kan leda till rivsår. I sällsynta fall påverkas levern eller blodkropparna, så kontakta oss om katten verkar sjuk eller får feber, om huden eller slemhinnorna blir gulaktiga eller om katten blöder lätt. T4, njurvärden och blodbild kontrolleras ungefär 3, 6, 10 och 20 veckor efter att behandlingen har inletts, efter varje dosändring och sedan med några månaders mellanrum. Tiamazol kan skada ett ofött barn. Tvätta händerna efter att du har gett medicinen och efter att du har skött kattlådan eller tagit hand om kattens spyor, och dela eller krossa inte tabletterna. Kvinnor som kan bli gravida bör använda engångshandskar när de ger medicinen, sköter kattlådan eller tar hand om spyor. Om du är gravid, kanske är gravid eller planerar en graviditet, låt någon annan ge medicinen och sköta kattlådan. 2) Kirurgi (tyreoidektomi) kan bota sjukdomen. Hos ungefär 70 % av katterna är båda sköldkörtelloberna drabbade, och om båda tas bort kan de närliggande bisköldkörtlarna skadas, vilket kan leda till övergående eller bestående låg kalciumhalt i blodet. Katten stabiliseras först med medicin, eftersom narkos innebär en extra risk för en obehandlad katt med hypertyreos. 3) Radiojodbehandling (I-131) anses vara förstahandsvalet för de flesta katter: en enda behandling botar över 95 % av katterna. I Finland erbjuds den bara vid ett par specialiserade kliniker. Katten vårdas isolerad på kliniken i flera dagar. Därefter ska den hållas inomhus hemma i ungefär två veckor, och barn och gravida kvinnor får inte ha kontakt med den. Den behandlande kliniken ger detaljerade instruktioner, bland annat om hur kattens avföring ska hanteras. Före kirurgi eller radiojodbehandling kan en provbehandling med medicin hjälpa till att förutsäga hur njurarna klarar sig när sköldkörteln väl är under kontroll. 4) Jodfattigt veterinärfoder (Hill’s y/d): fodret fungerar bara om katten inte äter något annat – inte ens godbitar, andra husdjurs mat eller byten – och även då inte hos alla katter. En del katter vägrar dessutom äta fodret eftersom de inte tycker om smaken. Därför passar det främst innekatter i hem med bara en katt. Vi hjälper dig att välja det alternativ som passar bäst för din katts situation.',
    en: 'There are four treatment options. 1) Daily medication with thiamazole (also known as methimazole), as tablets (e.g., Felimazole) or an oral solution (e.g., Apelka): relatively inexpensive, but lifelong. Most cats tolerate it well. Side effects usually appear in the first weeks and seldom after two to three months. They include vomiting, poor appetite, lethargy or severe itching of the head and neck that can cause scratch wounds. Rarely, the liver or blood cells are affected, so contact us if your cat becomes unwell or feverish, turns yellowish or bleeds easily. T4, kidney values and blood counts are checked about 3, 6, 10 and 20 weeks after starting and after every dose change, then every few months. Thiamazole may harm an unborn child. Wash your hands after giving the medicine and after handling the cat’s litter or vomit, and do not split or crush the tablets. Women who could become pregnant should wear disposable gloves when giving the medicine and handling litter or vomit. If you are pregnant, may be pregnant or are planning a pregnancy, let someone else give the medicine and clean the litter tray. 2) Surgery (thyroidectomy) can cure the disease. In about 70 % of cats, both thyroid lobes are affected, and removing both can damage the nearby parathyroid glands and cause low blood calcium, which may be temporary or permanent. The cat is first stabilized with medication, because anesthesia carries extra risk in an untreated hyperthyroid cat. 3) Radioactive iodine (I-131) is considered the treatment of choice for most cats: a single treatment cures more than 95 %. In Finland, it is offered at only a couple of specialized clinics. The cat stays in isolation in the hospital for several days. For about two weeks after returning home, it must be kept indoors, and children and pregnant women must not be in contact with it. The treating clinic gives detailed instructions, including how to handle the cat’s feces. Before surgery or radioactive iodine, a trial period on medication can help predict how the kidneys will cope once the thyroid is controlled. 4) An iodine-restricted prescription diet (Hill’s y/d) works only if the cat eats nothing else — not even treats, other pets’ food or prey — and even then not in every cat. Some cats also refuse it because of the taste. It is therefore suitable mainly for indoor cats in single-cat homes. We will help you choose the best option for your cat’s situation.'
  },
