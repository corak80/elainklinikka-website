...
const translations = {
  ...
  'article.ibdlymphoma.title': {
    fi: 'IBD vai lymfooma? – kissan tunnetusti vaikea erotusdiagnoosi',
    sv: 'IBD eller lymfom? – en notoriskt svår differentialdiagnos hos katter',
    en: 'IBD or Lymphoma? — A Notoriously Difficult Differential Diagnosis in Cats'
  },
  'article.ibdlymphoma.intro': {
    fi: 'Kissan tulehduksellista suolistosairautta (IBD) ja matala-asteista suoliston lymfoomaa on tunnetusti vaikea erottaa toisistaan. Molempia tavataan pääasiassa keski-ikäisillä ja iäkkäillä kissoilla, ja matala-asteinen lymfooma on hyvin harvinainen alle 8-vuotiailla. Oireisiin kuuluvat laihtuminen (yleisin oire), oksentelu, ripuli ja ruokahalun muutokset. Oireet voivat kuitenkin olla lieviä, eikä ripulia välttämättä ole lainkaan. Sairauksien erottaminen on tärkeää, koska niiden hoito ja ennuste voivat olla erilaiset: IBD:tä hoidetaan ruokavaliolla ja tarvittaessa kortikosteroideilla, kun taas matala-asteinen lymfooma vaatii yleensä lisäksi suun kautta annettavaa solunsalpaajahoitoa (kemoterapiaa).',
    sv: 'Hos katter är inflammatorisk tarmsjukdom (IBD) och låggradigt (småcelligt) intestinalt lymfom notoriskt svåra att skilja åt. Båda drabbar främst medelålders och äldre katter, och låggradigt lymfom är mycket ovanligt före 8 års ålder. Till symtomen hör viktnedgång (det vanligaste), kräkningar, diarré och förändrad aptit. De kan vara lindriga, och diarré kan saknas. Skillnaden är viktig, eftersom behandling och prognos kan vara olika: IBD behandlas med kost och vid behov kortikosteroider, medan låggradigt lymfom oftast också kräver kemoterapi i tablettform.',
    en: 'In cats, inflammatory bowel disease (IBD) and low-grade intestinal lymphoma are notoriously hard to tell apart. Both mainly affect middle-aged and older cats; low-grade lymphoma is very uncommon before 8 years of age. Signs include weight loss (the most common sign), vomiting, diarrhea, and changes in appetite. They can be mild, and diarrhea may be absent. The distinction matters because treatment and prognosis can differ: IBD is managed with diet and, if needed, corticosteroids, whereas low-grade lymphoma usually also needs oral chemotherapy.'
  },
  'article.ibdlymphoma.challenge.title': {
    fi: 'Miksi sairauksia on niin vaikea erottaa toisistaan',
    sv: 'Varför sjukdomarna är så svåra att skilja åt',
    en: 'Why the Two Are So Difficult to Tell Apart'
  },
  'article.ibdlymphoma.challenge.text': {
    fi: 'IBD:n lymfoplasmasyyttinen muoto ja matala-asteinen lymfooma voivat näyttää mikroskoopissa hyvin samankaltaisilta – kummassakin pienet valkosolut (lymfosyytit) tunkeutuvat suoliston limakalvoon. Myös patologien arviot samoista suolen koepaloista voivat vaihdella huomattavasti. Lisäksi tulehdus ja lymfooma esiintyvät usein yhtä aikaa: jopa 60 %:lla matala-asteista lymfoomaa sairastavista kissoista on todettu samanaikainen tulehdus. Siksi on esitetty, että pitkäaikainen tulehdus voisi joissakin tapauksissa edetä lymfoomaksi – tätä ei kuitenkaan ole osoitettu. Kyse ei ehkä ole kahdesta täysin erillisestä sairaudesta vaan saman jatkumon eri kohdista.',
    sv: 'I mikroskop kan låggradigt lymfom och den lymfocytär-plasmacytära formen av IBD se mycket lika ut: i båda fallen tränger små vita blodkroppar (lymfocyter) in i tarmslemhinnan. Olika patologers bedömningar av samma tarmbiopsier kan också variera avsevärt. Dessutom förekommer inflammation och lymfom ofta tillsammans: hos upp till 60 % av katterna med låggradigt lymfom har man samtidigt hittat inflammation. Därför har det föreslagits att långvarig inflammation i vissa fall kan övergå i lymfom – men det har inte bevisats. De två är kanske inte helt skilda sjukdomar, utan snarare olika punkter på ett kontinuum.',
    en: 'Under the microscope, low-grade lymphoma and the lymphocytic-plasmacytic form of IBD can look very similar: in both, small white blood cells (lymphocytes) infiltrate the intestinal lining. Pathologists’ assessments of the same intestinal biopsies can also vary considerably. Furthermore, inflammation and lymphoma often coexist: concurrent inflammation has been found in up to 60% of cats with low-grade lymphoma. It has therefore been proposed that long-standing inflammation may, in some cases, progress to lymphoma — but this has not been proven. The two may not be entirely separate diseases, but rather points on a continuum.'
  },
  ...
  'article.ibdlymphoma.diagnosis.text': {
    fi: 'Veri-, virtsa- ja ulostetutkimuksilla suljetaan pois oireiden muita syitä, kuten kilpirauhasen liikatoimintaa, mutta niillä ei voi erottaa näitä kahta sairautta toisistaan. Ultraäänitutkimus auttaa koepalanoton suunnittelussa, mutta sillä ei voi luotettavasti erottaa IBD:tä lymfoomasta, eikä normaali ultraäänilöydös sulje sairautta pois. Diagnoosi edellyttää suolen koepaloja. Ne voidaan ottaa joko tähystyksessä tai leikkauksessa, ja klinikallamme tehdään kumpaakin. Kumpikaan menetelmä ei ole selvästi toista parempi, mutta leikkauksessa päästään myös ohutsuolen keskiosaan (jejunum), jossa muutoksia on usein ja joka jää suurelta osin tähystimen ulottumattomiin. Koepalojen mikroskooppitutkimus (histopatologia) on diagnostiikan kulmakivi, mutta se ei aina anna yksiselitteistä vastausta. <strong>Immunohistokemiassa</strong> värjätään solujen merkkiaineita (esim. CD3 ja CD20), jolloin nähdään, minkä tyyppisiä lymfosyytit ovat – noin 90 % matala-asteisista lymfoomista on T-soluperäisiä. Lisäksi värjäys näyttää, ovatko solut keskenään samanlaisia (tyypillistä lymfoomalle) vai sekoitus eri solutyyppejä (tyypillistä tulehdukselle). Tämä on hyödyllinen vihje, ei todiste. <strong>PARR-klonaalisuustutkimus</strong> on DNA-testi (PCR), joka näyttää, ovatko lymfosyytit yhden solun kopioita (monoklonaalinen, viittaa lymfoomaan) vai peräisin monesta eri solusta (polyklonaalinen, viittaa tulehdukseen). Sitä ei saa käyttää yksinään: yhdessä tutkimuksessa tulos oli klonaalinen tai osittain klonaalinen 70 %:lla kissoista, joilla oli tulehdus, ja lymfoomaa muistuttavia löydöksiä on todettu jopa terveillä kissoilla. Mikään yksittäinen testi ei ratkaise asiaa, vaan diagnoosi perustuu kaikkien löydösten kokonaisuuteen.',
    sv: 'Blod-, urin- och avföringsprov utesluter andra orsaker till symtomen, till exempel en överaktiv sköldkörtel (hypertyreos), men kan inte skilja de två sjukdomarna åt. Ultraljud hjälper till att planera biopsierna men kan inte på ett tillförlitligt sätt skilja IBD från lymfom, och ett normalt ultraljudsresultat utesluter inte sjukdom. För att ställa diagnos behövs vävnadsprov (biopsier) från tarmen. De kan tas antingen med endoskop eller kirurgiskt, och på vår klinik utför vi båda. Ingen av metoderna är klart överlägsen. Vid kirurgi når man dock också den mellersta delen av tunntarmen (jejunum), som ofta är drabbad men till stor del ligger utom räckhåll för endoskopet. Mikroskopisk undersökning av vävnaden (histopatologi) är hörnstenen i diagnostiken, men den ger inte alltid ett entydigt svar. <strong>Immunhistokemi</strong> innebär att cellmarkörer (t.ex. CD3 och CD20) färgas in för att visa vilken typ av lymfocyter det rör sig om – cirka 90 % av de låggradiga lymfomen är av T-cellsursprung. Metoden visar också om cellerna är likformiga (typiskt för lymfom) eller blandade (typiskt för inflammation) – en användbar ledtråd, inte ett bevis. <strong>PARR-klonalitetstest</strong> är ett DNA-test som visar om lymfocyterna är kopior av en enda cell (monoklonala, vilket tyder på lymfom) eller härstammar från många olika celler (polyklonala, vilket tyder på inflammation). Testet får inte användas ensamt: i en studie fick 70 % av katterna med inflammation ett klonalt eller delvis klonalt resultat, och lymfomliknande fynd har till och med påträffats hos friska katter. Inget enskilt test är avgörande – diagnosen grundar sig på alla fynd sammantagna.',
    en: 'Blood, urine, and stool tests rule out other causes of the signs, such as an overactive thyroid, but cannot distinguish the two. Ultrasound helps plan biopsies but cannot reliably tell IBD from lymphoma, and a normal scan does not rule out disease. A diagnosis requires intestinal biopsies. These can be taken with an endoscope or surgically, and we perform both at our clinic. Neither method is clearly superior, but surgery also gives access to the middle part of the small intestine (the jejunum), which is often affected yet largely beyond the endoscope’s reach. Microscopic examination of the tissue (histopathology) is the cornerstone of diagnosis, but it is not always conclusive. <strong>Immunohistochemistry</strong> stains cell markers (e.g., CD3 and CD20) to identify the type of lymphocyte — about 90% of low-grade lymphomas arise from T cells. It also shows whether the cells are uniform (typical of lymphoma) or mixed (typical of inflammation) — a helpful clue, not proof. <strong>PARR clonality testing</strong>, a DNA test, shows whether the lymphocytes are copies of a single cell (monoclonal, suggesting lymphoma) or come from many cells (polyclonal, suggesting inflammation). It must not be used on its own: in one study, 70% of cats with inflammation had a clonal or partly clonal result, and lymphoma-like findings have even been detected in healthy cats. No single test is decisive; the diagnosis rests on all the findings taken together.'
  },
  ...
  'article.ibdlymphoma.treatment.text': {
    fi: '<strong>IBD:n</strong> hoito etenee vaiheittain: ensin kokeillaan eliminaatioruokavaliota, jossa on hydrolysoitua tai kissalle uutta proteiinia. Pelkkä ruokavalio auttaa monia kissoja, ja tarvittaessa hoitoon lisätään prednisoloni. <strong>Matala-asteista lymfoomaa</strong> hoidetaan tavallisesti suun kautta annettavalla solunsalpaajahoidolla (klorambusiili ja prednisoloni). Kissat sietävät hoidon yleensä hyvin, mutta se vaatii säännöllisiä verikokeita. Julkaistuissa tutkimuksissa 69–96 % kissoista sai hoitovasteen, ja mediaanielinaika vaihteli noin 15 kuukaudesta yli 3 vuoteen. Osa kissoista eli yli 5 vuotta. Kummassakin sairaudessa B12-vitamiinia (kobalamiinia) annetaan lisänä, jos sen pitoisuus on matala. <strong>Korkea-asteinen lymfooma</strong> vaatii voimakkaampaa solunsalpaajahoitoa, ja sen ennuste on huomattavasti huonompi (mediaanielinaika julkaistuissa tutkimuksissa noin 1,5–9 kuukautta).',
    sv: '<strong>IBD</strong> behandlas stegvis: först med ett dietförsök (hydrolyserat foder eller foder med en för katten ny proteinkälla), som i sig hjälper många katter, och därefter vid behov med prednisolon. <strong>Låggradigt lymfom</strong> behandlas oftast med kemoterapi i tablettform (klorambucil och prednisolon). Behandlingen tolereras i allmänhet väl men kräver regelbundna blodprov. I publicerade studier svarade 69–96 % av katterna på behandlingen, och medianöverlevnaden varierade från cirka 15 månader till över 3 år; en del katter levde i mer än 5 år. Vid båda sjukdomarna ges tillskott av vitamin B12 (kobalamin) om halten är låg. <strong>Höggradigt lymfom</strong> kräver intensivare kemoterapi och har en betydligt sämre prognos (i publicerade studier är medianöverlevnaden ungefär 1,5–9 månader).',
    en: '<strong>IBD</strong> is managed step by step: first with a diet trial using a hydrolyzed or novel-protein food, which on its own helps many cats, and then with prednisolone if needed. <strong>Low-grade lymphoma</strong> is usually treated with oral chemotherapy (chlorambucil plus prednisolone), which is generally well tolerated but requires regular blood tests. In published studies, 69–96% of cats responded to treatment, and median survival ranged from about 15 months to over 3 years; some cats lived more than 5 years. In both conditions, vitamin B12 is supplemented if levels are low. <strong>High-grade lymphoma</strong> needs more intensive chemotherapy and has a far poorer prognosis (in published studies, median survival is roughly 1.5–9 months).'
  },
  'article.ibdlymphoma.why.title': {
    fi: 'Miksi oikea diagnoosi on tärkeä',
    sv: 'Varför en korrekt diagnos är viktig',
    en: 'Why an Accurate Diagnosis Matters'
  },
  'article.ibdlymphoma.why.text': {
    fi: 'Jos lymfoomaa hoidetaan IBD:nä, prednisoloni – joka kuuluu kummankin sairauden hoitoon – voi lievittää oireita joksikin aikaa. Hyvä vaste kortikosteroidihoitoon ei siksi sulje lymfoomaa pois. Muut immuunijärjestelmää lamaavat lääkkeet, kuten siklosporiini, voivat pahentaa toteamatonta syöpää. Eläimille tarkoitetun siklosporiinin valmisteyhteenvedon mukaan sitä ei saa käyttää eläimillä, joilla on tai on aiemmin ollut syöpä. Toisaalta jos IBD:tä hoidetaan solunsalpaajilla, kissa altistuu tarpeettomille haittavaikutuksille. Koepalat auttavat myös sulkemaan pois muita syitä, kuten korkea-asteista lymfoomaa tai tiettyjä infektioita. Suosittelemme perusteellisia tutkimuksia aina, kun oireiden syy on epäselvä – ota yhteyttä klinikkaamme.',
    sv: 'Om lymfom behandlas som IBD kan prednisolon – som ingår i behandlingen av båda sjukdomarna – lindra symtomen en tid. Att katten svarar bra på steroider utesluter därför inte lymfom. Andra immunhämmande läkemedel, till exempel ciklosporin, kan förvärra en oupptäckt cancer. Enligt produktresumén för ciklosporin som veterinärläkemedel får det inte användas till djur som har eller har haft cancer. Omvänt utsätts katten för onödiga biverkningar om IBD behandlas med kemoterapi. Biopsierna hjälper också till att utesluta andra orsaker, till exempel höggradigt lymfom eller vissa infektioner. Vi rekommenderar alltid en grundlig utredning när orsaken är oklar – kontakta gärna vår klinik.',
    en: 'If lymphoma is treated as IBD, prednisolone — part of the treatment for both — may ease the signs for a while. A good response to steroids therefore does not rule out lymphoma. Other immunosuppressants, such as cyclosporine, may worsen an undetected cancer. Cyclosporine’s veterinary product information states that it must not be used in animals with current or past cancer. Conversely, treating IBD with chemotherapy exposes the cat to unnecessary side effects. Biopsies also help rule out other causes, such as high-grade lymphoma or certain infections. We recommend a thorough workup whenever the cause is unclear — please contact our clinic.'
  },
