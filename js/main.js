...
const translations = {
  ...
  'article.brushing.how.text': {
    ...
    sv: 'Använd alltid tandkräm avsedd för djur — aldrig mänsklig tandkräm som kan innehålla xylitol (extremt giftigt för hundar) och fluorid. Djurtandkräm är säker att svälja och finns i kött- och fisk smaker. Fingerborste är bra för nybörjare och katter. Lyft läppen och borsta i 45 graders vinkel mot tandköttsranden med cirkulära rörelser. Fokusera på yttersidorna — tungan rengör insidorna naturligt. De viktigaste områdena är överkäkens bakre tänder och hörntänderna. 1–2 minuter räcker.',
