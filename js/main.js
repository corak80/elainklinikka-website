...
const translations = {
  ...
  'article.tta.risks.text': {
    fi: 'Kuten kaikkiin leikkauksiin, myös TTA:han liittyy komplikaatioiden riskejä, kuten infektio, implantin löystyminen, luun hitaampi paraneminen tai meniskivaurio (noin 9–10 % tapauksista). Komplikaatioriski pienenee kirurgin kokemuksen myötä. Klinikallamme valvomme anestesiaa tarkasti ja käytämme kattavaa kivunlievitystä kaikissa ortopedisissä leikkauksissa.',
  ...
  'article.brushing.how.text': {
    fi: 'Käytä aina eläimille tarkoitettua hammastahnaa — ei koskaan ihmisten tahnaa, joka voi sisältää ksylitolia (erittäin myrkyllistä koirille) ja fluorideja. Eläintahnat ovat turvallisia niellä, ja niitä on saatavana lihan- ja kalan makuisina. Sormiharja on hyvä aloittelijoille ja kissoille. Nosta lemmikin huulta ja harjaa hampaat 45 asteen kulmassa ienrajaa vasten pyörivin liikkein. Keskity ulkopintoihin — kieli puhdistaa sisäpintoja luonnollisesti. Tärkeimmät kohdat ovat yläleuan takahampaat ja kulmahampaiden alue. 1–2 minuuttia kerralla riittää.',
  ...
  'article.vaccination.dogs.text': {
    fi: 'Koirien perusrokotuksena annetaan DHPPi-rokote, joka suojaa neljältä taudilta: penikkataudilta (D), tarttuvalta maksatulehdukselta (H), parvovirukselta (P) ja parainfluenssalta (Pi). Lisäksi rabiesrokote kuuluu perusrokotuksiin — sitä suositellaan kaikille koirille ja on lakisääteinen metsästys- ja virkakoirille. Suosittelemme myös kennelyskärokotusta kaikille koirille kerran vuodessa. Leptospiroosirokotus suositellaan vain endeemisille alueille matkustaville — Suomi ei ole endeeminen alue.',
  ...
  'article.vaccination.cats.text': {
    fi: 'Kaikille kissoille suositellaan kolmoisrokotusta (RCP): kissaruttoa (FPV), kalikivirusta (FCV) ja herpesvirusta (FHV-1) vastaan. Hengitystievirusta rokotus ei estä kokonaan, mutta lieventää oireita merkittävästi. Rabiesrokotusta suositellaan ulkokissoille ja on pakollinen matkustaville kissoille. Kissaleukemia (FeLV) ei kuulu Suomen rutiinirokotuksiin, sillä FeLV:n esiintyvyys Suomessa on lähes nolla — sitä suositellaan vain FeLV-positiivisen kissan kanssa asuville.',
  ...
  'article.vaccination.schedule.text': {
    fi: 'Kissanpennut: Ensimmäinen RCP-rokotus 12 viikon iässä, toinen 16 viikon iässä. Tehosterokotus vuoden kuluttua toisesta rokotuksesta. Aikuisilla kissoilla RCP 3 vuoden välein.<br><br>Koiranpennut: Ensimmäinen DHPPi-rokotus 12 viikon iässä, toinen 16 viikon iässä, rabiesrokotus 16 viikon iässä. Tehosterokotukset vuoden kuluttua toisesta rokotuksesta. Aikuisilla koirilla DHPPi ja rabies 3 vuoden välein, kennelyskä kerran vuodessa.',
  ...
  'article.vaccination.travel.text': {
    fi: 'EU:n alueella matkustamiseen vaaditaan mikrosiru (ennen rabiesrokotusta), voimassa oleva rabiesrokotus (vähintään 21 päivää ennen matkaa) ja EU-lemmikkipassi. Koirilta vaaditaan lisäksi ekinokokkoosilääkitys 1–5 päivää ennen Suomeen paluuta. Vaihtoehtoisesti voidaan käyttää 28 päivän sääntöä: kaksi hoitoa ennen matkaa (hoitojen välillä min 24h ja max 28vrk) ja kolmas Suomeen saapumisen jälkeen, joka päättää 28vrk:n lääkityssyklin. Riskimaista (esim. Venäjä, Turkki) saapuvilta vaaditaan rabiesvasta-ainepitoisuustesti EU-hyväksytyssä laboratoriossa. Varaa aika rokotuksille ja matkustusasiakirjoille — hoidamme EU-lemmikkipassit klinikallamme.',
