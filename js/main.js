...
const translations = {
  ...
  'privacy.digital.text': { fi: 'Verkkosivusto ei käytä evästeitä eikä seurantateknologioita. Ajanvaraus tapahtuu ProvetCloud-järjestelmän kautta, jonka tietosuojasta vastaa Finnish Net Solutions Oy. WhatsApp-viestipalvelussa viestejä käsittelee tekoälypohjainen chatbot asiakaspalvelun tueksi.', sv: 'Webbplatsen använder inga cookies eller spårningstekniker. Tidsbokning sker via ProvetCloud-systemet, vars dataskydd ansvaras av Finnish Net Solutions Oy. I WhatsApp-meddelandetjänsten behandlas meddelanden av en AI-baserad chatbot som stöd för kundservicen.', en: 'The website does not use cookies or tracking technologies. Appointments are booked through the ProvetCloud system, whose data protection is managed by Finnish Net Solutions Oy. In the WhatsApp messaging service, messages are processed by an AI-powered chatbot to support customer service.' },
