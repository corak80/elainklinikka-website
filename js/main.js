...
const translations = {
  ...
  'article.vaccination.travel.text': {
    fi: 'EU:n alueella matkustamiseen tarvitaan <strong>mikrosiru</strong> (ennen rabiesrokotusta), voimassa oleva <strong>rabiesrokotus</strong> (vähintään 21 päivää ennen matkaa) ja <strong>EU-lemmikkipassi</strong>. Koirilta vaaditaan lisäksi <strong>ekinokokkoosilääkitys</strong> 1–5 päivää ennen Suomeen paluuta. Vaihtoehtoisesti voidaan käyttää 28 päivän sääntöä: kaksi hoitoa enintään 28 päivän välein ennen matkaa ja kolmas Suomeen saapumisen jälkeen. Riskimaista (esim. Venäjä, Turkki) saapuvilta vaaditaan rabiesvasta-ainepitoisuustesti EU-hyväksytyssä laboratoriossa. Varaa aika rokotuksille ja matkustusasiakirjoille — hoidamme EU-lemmikkipassit klinikallamme.',
