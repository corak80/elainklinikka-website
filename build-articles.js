...
const servicePages = [
  ...
  },
  {
    ...
    metaDesc: 'Päivittäin varatut akuuttiajat Eläinklinikka Saarella arkisin 9–17. Yöt ja viikonloput: alueen päivystysnumero 0600 399 299. Hätätilanteen ensiapu.',
    icon: '🚨',
    sections: [
      { heading: 'Päivittäiset akuuttiajat arkisin 9–17', text: 'Varaamme joka arkipäivälle akuuttiaikoja kiireellisiä tapauksia varten. Soita numeroon (06) 321 7300 — vaikka päivän kalenteri näyttäisi täydeltä, akuuttiaika voi silti olla saatavilla. Puhelimessa arvioimme tilanteen, annamme ensiapuohjeita matkan ajaksi ja valmistaudumme vastaanottoon.' },
      { heading: 'Milloin se on hätätilanne?', text: 'Seuraavat oireet ovat aina syy ottaa yhteyttä eläinlääkäriin ilman viivettä: <strong>hengitysvaikeudet</strong> (haukkominen, sinerrys ikenissä, suun kautta hengittäminen kissalla), <strong>tajuttomuus tai krampit</strong>, <strong>voimakas verenvuoto tai laaja haava</strong>, <strong>liikennevahinko, putoaminen tai muu vakava trauma</strong>, <strong>virtsaamisvaikeudet tai virtsaamisen täydellinen estyminen</strong> — kiireellisimmillään urosskissalla (virtsaputken tukos johtaa munuaisten vajaatoimintaan noin vuorokaudessa), mutta myös koirilla aito hätätilanne (virtsakivet, eturauhassairaudet, kasvaimet). Mikä tahansa lemmikki joka ponnistaa toistuvasti tuottamatta virtsaa tarvitsee välittömän arvion. <strong>Koira jolla vatsa on turvonnut ja yrittää oksentaa tuloksetta</strong> (mahalaukun kiertymä on hengenvaarallinen), <strong>myrkyllisen aineen nauttiminen</strong> (suklaa, ksylitoli, antifreeze, viinirypäleet, sipuli, ihmislääkkeet), <strong>kyynpurema</strong> (Suomen ainoa myrkyllinen käärme — tarvitsee aina eläinlääkärin arvion), <strong>voimakas oksentelu tai ripuli yli vuorokauden</strong>, <strong>silmävamma tai äkillinen sokeus</strong>, <strong>hallitsematon kipu</strong>, <strong>tiine narttu joka on synnytyksessä yli puoli tuntia ilman edistymistä</strong>.' },
      { heading: 'Miten toimit hätätilanteessa', text: '<strong>1. Soita ensin.</strong> Virka-aikana (06) 321 7300. Virka-ajan ulkopuolella alueen päivystysnumero 0600 399 299 (katso seuraava osio). Saamme valmistauduttua ja annamme ensiapuneuvoja matkan ajaksi. <strong>2. Pidä lemmikki lämpimänä ja rauhallisena.</strong> Traumapotilaita kuljetettaessa käytä tasaista alustaa — peittoa tai matalaa laatikkoa — käsiin nostaminen voi pahentaa selkä- tai nivelvammoja. <strong>3. Myrkytysepäilyssä ota mukaan pakkaus tai näyte.</strong> Älä yritä oksennuttaa kotona ilman puhelinneuvottelua — joissakin myrkytyksissä (syövyttävät aineet, terävät esineet) se on vaarallista. <strong>4. Älä anna ihmislääkkeitä.</strong> Parasetamoli on kissalle hengenvaarallinen, ibuprofeeni vaurioittaa koiran ruoansulatuskanavaa ja munuaisia. <strong>5. Tunnista sokin oireet:</strong> kylmät korvat ja tassut, vaaleat ikenet, nopea pinnallinen hengitys, väsähtäminen — sokki vaatii välitöntä nestehoitoa eläinlääkärin valvonnassa.' },
      { heading: 'Iltaisin ja viikonloppuisin — Pohjoinen päivystysalue', text: 'Eläinklinikka Saari on suljettu iltaisin ja viikonloppuisin, eikä toimistonumeroomme vastata virka-ajan ulkopuolella. Vaasan alueelle — kattaen <strong>Vaasan, Mustasaaren, Laihian, Vähänkyrön ja Vöyrin</strong> — on alueellinen iltapäivystysnumero:<br><br>☎ <strong>0600 399 299</strong><br>Arki-iltaisin 16.00 → 08.00 seuraavana aamuna<br>Viikonloput perjantai 16.00 → maanantai 08.00<br><br>Päivystävä eläinlääkäri arvioi tilanteen ja ohjeistaa minne tulla. Puhelumaksu on 1,53 €/min päivisin ja 3,55 €/min öisin; käynti- ja toimenpidemaksuihin lisätään 50–100 % päivystyskorotus alueen ohjeistuksen mukaan.<br><br><strong>Laajan tuntimäärän sairaalahoitoa tarvitseville</strong> lähin vaihtoehto on <strong>Evidensia Seinäjoen Eläinsairaala</strong> (Ravitie 8 B, Seinäjoki — noin 1 t 15 min ajomatkan päässä Vaasasta). Aukioloajat: ma–la 8–21, su 9.30–18. Triage-numero 0600 41 8823.<br><br><strong>24/7 sairaalahoitoa</strong> lähinnä tarjoaa <strong>Eläinklinikka Syke (Evidensia)</strong> Porissa (Itäkeskuksenkaari 8) — noin 2 tunnin ajomatka, ~195 km. Seuraava 24/7 vaihtoehto on <strong>Eläinsairaala Veter (Evidensia)</strong> Tampereella (Peltokatu 16) — noin 3 tunnin ajomatka.' },
      { heading: 'Yleisimmät hätätilanteet — lue lisää', text: 'Olemme koonneet sivuillemme tarkempaa tietoa muutamasta yleisimmästä hätätilanteesta: <a href="/articles/kyynpurema.html">kyynpureman hoito ja ensiapu</a>, <a href="/articles/kohtutulehdus.html">kohtutulehdus (pyometra)</a> ja <a href="/articles/ripuli.html">akuutti ripuli koiralla ja kissalla</a>. Tilanteen tunnistaminen ajoissa parantaa hoidon tuloksia merkittävästi.' },
    ],
    sv: {
      title: 'Akut veterinär Vasa | Djurklinik Saari',
      h1: 'Akut veterinär i Vasa',
      metaDesc: 'Dagligen reserverade akuttider på Djurklinik Saari vardagar 9–17. Kvällar och helger: regionens jourtelefon 0600 399 299. Förstahjälp vid nödsituationer.',
      sections: [
        { heading: 'Dagligen reserverade akuttider — vardagar 9–17', text: 'Vi reserverar akuttider varje vardag för brådskande fall. Ring (06) 321 7300 — även om dagens kalender ser full ut kan en akuttid ändå finnas tillgänglig. Per telefon bedömer vi situationen, ger förstahjälpsråd för resan och förbereder mottagningen.' },
        { heading: 'När är det en nödsituation?', text: 'Följande symtom är alltid skäl att kontakta veterinär utan dröjsmål: <strong>andningssvårigheter</strong> (flämtning, blåaktiga tandkött, andning genom munnen hos katt), <strong>medvetslöshet eller kramper</strong>, <strong>kraftig blödning eller större sår</strong>, <strong>trafikolycka, fall eller annat allvarligt trauma</strong>, <strong>svårigheter att urinera eller fullständigt urinstopp</strong> — mest brådskande hos hankatter (urinrörsstopp leder till njursvikt inom ungefär ett dygn), men också en äkta nödsituation hos hundar (urinstenar, prostatasjukdom, tumörer). Vilket djur som helst som krystar upprepade gånger utan att producera urin behöver omedelbar bedömning. <strong>Hund med uppsvälld buk och resultatlösa kräkningar</strong> (magomvridning är livshotande), <strong>intag av giftiga ämnen</strong> (choklad, xylitol, frostskyddsmedel, vindruvor, lök, humanläkemedel), <strong>huggormsbett</strong> (Finlands enda giftiga orm — kräver alltid veterinärbedömning), <strong>kraftiga kräkningar eller diarré över ett dygn</strong>, <strong>ögonskada eller plötslig blindhet</strong>, <strong>okontrollerad smärta</strong>, <strong>dräktig tik som är i förlossning över en halvtimme utan framsteg</strong>.' },
        { heading: 'Hur agera i nödsituation', text: '<strong>1. Ring först.</strong> Under arbetstid (06) 321 7300. Utanför arbetstid regionens jourtelefon 0600 399 299 (se nästa avsnitt). Vi förbereder oss och ger förstahjälpsråd för resan. <strong>2. Håll djuret varmt och lugnt.</strong> Vid transport av traumapatienter, använd ett plant underlag — filt eller låg låda — att lyfta upp i armarna kan förvärra rygg- eller ledskador. <strong>3. Vid misstänkt förgiftning, ta med förpackningen eller ett prov</strong> av spyan. Försök inte framkalla kräkning hemma utan telefonkonsultation — vid vissa förgiftningar (frätande ämnen, vassa föremål) är det farligt. <strong>4. Ge inte humanläkemedel.</strong> Paracetamol är livshotande för katt, ibuprofen skadar hundens mag-tarmkanal och njurar. <strong>5. Känn igen chocktecken:</strong> kalla öron och tassar, blekt tandkött, snabb ytlig andning, slöhet — chock kräver omedelbar vätskebehandling under veterinärvård.' },
        { heading: 'Kvällar och helger — Norra jourområdet', text: 'Djurklinik Saari är stängd kvällar och helger, och vårt kontorsnummer besvaras inte utanför arbetstid. För Vasaregionen — som omfattar <strong>Vasa, Korsholm, Laihela, Lillkyro och Vörå</strong> — finns en regional kvälls- och helgjourtelefon:<br><br>☎ <strong>0600 399 299</strong><br>Vardagskvällar 16.00 → 08.00 nästa morgon<br>Helger fredag 16.00 → måndag 08.00<br><br>En jourveterinär bedömer ärendet per telefon och anvisar var ni ska söka vård. Samtalskostnad 1,53 €/min dagtid och 3,55 €/min nattetid; besöks- och åtgärdsavgifter höjs med 50–100 % enligt regionens jourtaxa.<br><br><strong>För fall som kräver sjukhusvård med längre öppettider</strong> är närmaste alternativ <strong>Evidensia Seinäjoen Eläinsairaala</strong> (Ravitie 8 B, Seinäjoki — cirka 1 t 15 min körväg från Vasa). Öppettider: må–lö 8–21, sö 9.30–18. Triagenummer 0600 41 8823.<br><br><strong>24/7 sjukhusvård</strong> finns närmast på <strong>Eläinklinikka Syke (Evidensia)</strong> i Björneborg (Itäkeskuksenkaari 8) — cirka 2 timmars körväg, ~195 km. Nästa 24/7-alternativ är <strong>Eläinsairaala Veter (Evidensia)</strong> i Tammerfors (Peltokatu 16) — cirka 3 timmars körväg.' },
        { heading: 'Vanligaste nödsituationer — läs mer', text: 'Vi har samlat mer information om några av de vanligaste nödsituationerna på våra sidor: <a href="/sv/artiklar/huggormsbett.html">huggormsbett — behandling och förstahjälp</a>, <a href="/sv/artiklar/livmoderinflammation.html">livmoderinflammation (pyometra)</a> och <a href="/sv/artiklar/diarre.html">akut diarré hos hund och katt</a>. Att känna igen situationen i tid förbättrar behandlingsresultatet avsevärt.' },
      ],
      ctaTitle: 'Ring oss',
      ctaText: 'Ring innan ni kommer, så förbereder vi mottagningen.',
      ctaCall: 'Ring (06) 321 7300',
      ctaBook: 'Boka online',
      back: '← Tillbaka till startsidan',
      relatedTitle: 'Relaterade artiklar',
      faq: [
        { q: 'Kan jag komma utan tidsbokning vid en akut situation?', a: 'Under arbetstid (vardagar 9–17) ja — vi reserverar dagligen akuttider just för detta. Ring alltid (06) 321 7300 först så att vi kan förbereda mottagningen och ge förstahjälpsråd per telefon.' },
        { q: 'Vad gör jag om det är en nödsituation utanför arbetstid?', a: 'Ring den regionala jourtelefonen 0600 399 299. Den betjänar Vasa, Korsholm, Laihela, Lillkyro och Vörå vardagskvällar 16–08 och helger fredag 16 → måndag 08.' },
        { q: 'Var finns närmaste 24/7-djursjukhus?', a: 'Eläinklinikka Syke (Evidensia) i Björneborg, cirka 2 timmars körväg från Vasa. För fall som kräver inneliggande vård kan jourtelefonen vägleda om ni ska åka dit eller till ett närmare alternativ med längre öppettider (Evidensia Seinäjoen Eläinsairaala, cirka 1 t 15 min bort, öppet till 21.00 må–lö).' },
        { q: 'Vad gör jag om mitt djur ätit något giftigt?', a: 'Under arbetstid, ring oss på (06) 321 7300 och ta med förpackningen eller ett prov. Utanför arbetstid, ring 0600 399 299. Försök inte framkalla kräkning hemma utan veterinärkonsultation — vid vissa förgiftningar förvärrar det situationen.' },
        { q: 'Hur känner jag igen chock?', a: 'Kalla öron och tassar, blekt tandkött, snabb ytlig andning och plötslig slöhet. Chock är alltid livshotande och kräver omedelbar vätskebehandling under veterinärvård — sök hjälp direkt.' },
        { q: 'Tillkommer extra avgift för ett akutbesök hos Saari?', a: 'Nej — en akuttid under arbetstid kostar samma som ett vanligt besök. Åtgärder och undersökningar debiteras enligt vår ordinarie prislista. Den regionala jourtelefonen har egna minuttaxor och förhöjda besöksavgifter, vilka fastställs regionalt och inte av oss.' }
      ],
    },
    en: {
      ...
      sections: [
        ...
        { heading: 'When is it an emergency?', text: 'The following symptoms always warrant contacting a veterinarian without delay: <strong>breathing difficulty</strong> (open-mouth panting, bluish gums, cats breathing through the mouth), <strong>unconsciousness or seizures</strong>, <strong>heavy bleeding or a large wound</strong>, <strong>traffic accident, fall, or other serious trauma</strong>, <strong>difficulty or inability to urinate</strong> — most urgent in male cats (urethral blockage progresses to kidney failure within ~24 hours), but also a true emergency in dogs (urethral stones, prostate disease, tumours). Any pet straining repeatedly without producing urine needs to be seen immediately. <strong>A dog with a swollen abdomen attempting to vomit unsuccessfully</strong> (gastric torsion is life-threatening), <strong>ingestion of toxic substances</strong> (chocolate, xylitol, antifreeze, grapes, onion, human medications), <strong>adder bite</strong> (Finland\'s only venomous snake — always requires veterinary assessment), <strong>severe vomiting or diarrhoea lasting over 24 hours</strong>, <strong>eye injury or sudden blindness</strong>, <strong>uncontrolled pain</strong>, <strong>a pregnant female in labour for over 30 minutes without progress</strong>.' },
        { heading: 'What to do in an emergency', text: '<strong>1. Call first.</strong> During business hours: (06) 321 7300. Outside business hours: the regional hotline 0600 399 299 (see next section). We can prepare and give first-aid advice for the journey. <strong>2. Keep your pet warm and calm.</strong> When transporting trauma patients, use a flat surface — a blanket or shallow box — lifting in your arms can worsen spinal or joint injuries. <strong>3. With suspected poisoning, bring the packaging or a sample</strong> of any vomit. Do not attempt to induce vomiting at home without consulting us first — in some poisonings (corrosive substances, sharp objects) it is dangerous. <strong>4. Do not give human medications.</strong> Paracetamol is fatal to cats; ibuprofen damages a dog\'s gastrointestinal tract and kidneys. <strong>5. Recognise shock:</strong> cold ears and paws, pale gums, rapid shallow breathing, lethargy — shock requires immediate fluid therapy under veterinary care.' },
        { heading: 'Evenings and weekends — Northern Emergency Area', text: 'Saari Animal Clinic is closed evenings and weekends, and our office number rings unanswered outside business hours. For the Vaasa region — covering <strong>Vaasa, Mustasaari, Laihia, Vähäkyrö and Vöyri</strong> — there is a regional after-hours veterinary emergency hotline:<br><br>☎ <strong>0600 399 299</strong><br>Weekday evenings 16:00 → 08:00 next morning<br>Weekends Friday 16:00 → Monday 08:00<br><br>A veterinarian on duty assesses your case by phone and tells you where to go. Standard call charges apply (1.53 €/min daytime, 3.55 €/min nights); emergency consultation fees are surcharged 50–100 % per regional rules.<br><br><strong>For cases needing extended-hours hospital care</strong>, the closest option is <strong>Evidensia Seinäjoen Eläinsairaala</strong> (Ravitie 8 B, Seinäjoki — approximately 1 h 15 min drive from Vaasa). Hours: Mon–Sat 8–21, Sun 9:30–18. Triage line 0600 41 8823.<br><br><strong>For 24/7 inpatient care</strong>, the nearest hospital is <strong>Eläinklinikka Syke (Evidensia)</strong> in Pori (Itäkeskuksenkaari 8) — approximately 2 hours\' drive, ~195 km. After Pori, the next 24/7 option is <strong>Eläinsairaala Veter (Evidensia)</strong> in Tampere (Peltokatu 16) — approximately 3 hours\' drive.' },
        { heading: 'Common emergencies — read more', text: 'We have collected detailed information about some of the most common emergencies on our site: <a href="/en/articles/snake-bite.html">adder bite — treatment and first aid</a>, <a href="/en/articles/pyometra.html">pyometra (uterine infection)</a> and <a href="/en/articles/diarrhoea.html">acute diarrhoea in dogs and cats</a>. Recognising these conditions early significantly improves treatment outcomes.' },
      ],
      ctaTitle: 'Call us',
      ...
      faq: [
        ...
        { q: 'Where is the nearest 24/7 small-animal hospital?', a: 'Eläinklinikka Syke (Evidensia) in Pori, approximately 2 hours\' drive from Vaasa. For cases that need overnight hospitalisation, the regional hotline can advise whether to head there or to a closer extended-hours option (Evidensia Seinäjoen Eläinsairaala, about 1 h 15 min away, open until 21:00 Mon–Sat).' },
        { q: 'What do I do if my pet ate something toxic?', a: 'During business hours, call us at (06) 321 7300 and bring the packaging or a sample. Outside business hours, call 0600 399 299. Do not induce vomiting at home without consulting a vet first — in some poisonings it makes the situation worse.' },
        { q: 'How do I recognise shock?', a: 'Cold ears and paws, pale gums, rapid shallow breathing, and sudden lethargy. Shock is always life-threatening and requires immediate fluid therapy under veterinary supervision — call for help straight away.' },
        { q: 'Is there an extra fee for an emergency appointment at Saari?', a: 'No — an acute appointment during business hours costs the same as a regular consultation. Procedures and tests are charged per our regular price list. The regional after-hours hotline has its own per-minute charges and surcharged visit fees, which are set regionally, not by us.' }
      ],
    },
    relatedArticles: ['kyynpurema', 'kohtutulehdus', 'anestesiaturvallisuus'],
    schemaService: 'Emergency Veterinary Care',
    faq: [
      { q: 'Voinko tulla ilman ajanvarausta hätätilanteessa?', a: 'Virka-aikana (arkisin 9–17) kyllä — varaamme päivittäin akuuttiaikoja juuri tätä varten. Soita aina ensin numeroon (06) 321 7300, jotta voimme valmistautua ja antaa ensiapuneuvoja puhelimessa.' },
      ...
      { q: 'Missä on lähin 24/7 pieneläinpäivystys?', a: 'Eläinklinikka Syke (Evidensia) Porissa, noin 2 tunnin ajomatkan päässä Vaasasta. Tapauksissa joissa tarvitaan yöpyminen sairaalassa, alueen päivystysnumero osaa neuvoa joko Poriin tai lähempänä olevaan laajemman aukiolon vaihtoehtoon (Evidensia Seinäjoen Eläinsairaala, noin 1 t 15 min päässä, auki klo 21:een asti ma–la).' },
      { q: 'Mitä teen, jos lemmikkini on syönyt jotain myrkyllistä?', a: 'Virka-aikana soita meille numeroon (06) 321 7300 ja ota mukaan pakkaus tai näyte. Virka-ajan ulkopuolella soita 0600 399 299. Älä yritä oksennuttaa kotona ilman puhelinneuvottelua — joissakin myrkytyksissä se pahentaa tilannetta.' },
      { q: 'Kuinka tunnistan sokin?', a: 'Sokin oireita ovat kylmät korvat ja tassut, vaaleat ikenet, nopea pinnallinen hengitys ja äkillinen väsähtäminen. Sokki on aina hengenvaarallinen ja vaatii välitöntä nestehoitoa eläinlääkärin valvonnassa — hae apua välittömästi.' },
      { q: 'Onko hätäkäynnistä lisämaksu Saarella?', a: 'Ei — virka-ajan akuuttikäynti maksaa saman kuin tavanomainen vastaanottokäynti. Tutkimuksista ja hoidoista veloitetaan tavanomaisen hinnaston mukaan. Alueen päivystysnumerolla on omat minuuttitaksat ja päivystyskorotetut käyntimaksunsa, jotka määräytyvät alueellisesti, eivät meidän osaltamme.' },
    ]
  },
];
