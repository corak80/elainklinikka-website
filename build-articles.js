...
const servicePages = [
  ...
  },
  {
    ...
    metaDesc: 'Akuutti eläinlääkäri Vaasassa arkisin 9–17. Soita (06) 321 7300 ennen tuloa — järjestämme tilan kiireellisille tapauksille. Hätätilanteen ensiapu ja toimintaohjeet. Eläinklinikka Saari.',
    icon: '🚨',
    sections: [
      { heading: 'Akuutti hoito arkisin 9–17', text: 'Eläinklinikka Saari on avoinna arkisin klo 9–17. Akuuteissa tilanteissa pyrimme aina järjestämään tilan saman päivän kiireellisille tapauksille — soita ensin numeroon (06) 321 7300, niin voimme arvioida tilanteen, antaa ensiapuohjeita matkan ajaksi ja varautua vastaanottoon. Pelkkä yllättävä saapuminen ilman puhelinkontaktia voi johtaa pitkään odotukseen, jos varatut potilaat ovat samaan aikaan vastaanotolla. Vaasan alueella ei ole erillistä eläinlääkäripäivystystä iltaisin tai viikonloppuisin, mutta arkipäivien aikana akuuttihoito on yhden puhelinsoiton päässä.' },
      { heading: 'Milloin soittaa heti', text: 'Seuraavat oireet ovat aina syy ottaa yhteyttä eläinlääkäriin ilman viivettä: <strong>hengitysvaikeudet</strong> (haukkominen, sinerrys ikenissä, suun kautta hengittäminen kissalla), <strong>tajuttomuus tai krampit</strong>, <strong>voimakas verenvuoto tai laaja haava</strong>, <strong>liikennevahinko, putoaminen tai muu vakava trauma</strong>, <strong>kissa joka ei pysty virtsaamaan</strong> (virtsatietukos on hengenvaarallinen jo muutamissa tunneissa), <strong>koira jolla vatsa on turvonnut ja yrittää oksentaa tuloksetta</strong> (mahalaukun kiertymä on hengenvaarallinen), <strong>myrkyllisen aineen nauttiminen</strong> (suklaa, ksylitoli, antifreeze, viinirypäleet, sipuli, ihmislääkkeet), <strong>kyynpurema</strong> (Suomen ainoa myrkyllinen käärme — tarvitsee aina eläinlääkärin arvion), <strong>voimakas oksentelu tai ripuli yli vuorokauden</strong>, <strong>silmävamma tai äkillinen sokeus</strong>, <strong>hallitsematon kipu</strong>, <strong>tiine narttu joka on synnytyksessä yli puoli tuntia ilman edistymistä</strong>.' },
      { heading: 'Miten toimit hätätilanteessa', text: '<strong>1. Soita ensin numeroon (06) 321 7300.</strong> Saamme valmistauduttua ja annamme ensiapuneuvoja matkan ajaksi. <strong>2. Pidä lemmikki lämpimänä ja rauhallisena.</strong> Traumapotilaita kuljetettaessa käytä tasaista alustaa — peittoa tai matalaa laatikkoa — käsiin nostaminen voi pahentaa selkä- tai nivelvammoja. <strong>3. Myrkytysepäilyssä ota mukaan pakkaus tai näyte.</strong> Älä yritä oksennuttaa kotona ilman puhelinneuvottelua — joissakin myrkytyksissä (syövyttävät aineet, terävät esineet) se on vaarallista. <strong>4. Älä anna ihmislääkkeitä.</strong> Parasetamoli on kissalle hengenvaarallinen, ibuprofeeni vaurioittaa koiran ruoansulatuskanavaa ja munuaisia. <strong>5. Tunnista sokin oireet:</strong> kylmät korvat ja tassut, vaaleat ikenet, nopea pinnallinen hengitys, väsähtäminen — sokki vaatii välitöntä hoitoa nestehoitona.' },
      { heading: 'Iltaisin ja viikonloppuisin', text: 'Eläinklinikka Saari ei ole 24/7 päivystyspaikka, eikä Vaasan seudulla ole ympärivuorokautista pieneläinpäivystystä. Iltaisin (klo 17 jälkeen) ja viikonloppuisin lähimmät yöpäivystykset sijaitsevat Tampereella ja Helsingissä, noin 3–4 tunnin ajomatkan päässä. Hengenvaarallisissa tilanteissa suosittelemme soittamaan ensin valittuun 24/7 klinikkaan vahvistaaksenne, että teidät otetaan vastaan, ja saadaksenne ensiapuneuvoja pitkän matkan ajaksi. Voit soittaa myös meille — vaikka emme ole avoinna, vastaajaviestiin reagoimme heti aamulla ja järjestämme tarvittaessa ensimmäisen ajan.' },
      { heading: 'Yleisimmät hätätilanteet ja niiden taustat', text: 'Olemme koonneet sivuillemme tarkempaa tietoa muutamasta yleisimmästä hätätilanteesta. Lue tarvittaessa lisää: <a href="/articles/kyynpurema.html">kyynpureman hoito ja ensiapu</a>, <a href="/articles/kohtutulehdus.html">kohtutulehdus (pyometra)</a> ja <a href="/articles/ripuli.html">akuutti ripuli koiralla ja kissalla</a>. Tilanteen tunnistaminen ajoissa parantaa hoidon tuloksia merkittävästi.' },
      { heading: 'Usein kysyttyä päivystyksestä', text: '<strong>Voinko tulla ilman ajanvarausta akuutissa tilanteessa?</strong> Akuuteissa hätätilanteissa otamme potilaita arkisin 9–17 myös ilman ajanvarausta, mutta soita aina ensin numeroon (06) 321 7300. Näin saamme valmisteltua tilaa ja voimme antaa puhelimessa ensiapuneuvoja. <strong>Mikä on lähin 24/7 eläinpäivystys?</strong> Lähimmät ympärivuorokautiset pieneläinpäivystykset sijaitsevat Tampereella ja Helsingissä, noin 3–4 tunnin ajomatkan päässä Vaasasta. Hengenvaarallisissa tilanteissa soita ensin valitsemaasi päivystykseen — saat ensiapuneuvoja matkan ajaksi.' },
    ],
    sv: {
      title: 'Akut veterinär Vasa | Djurklinik Saari',
      h1: 'Akut veterinär i Vasa',
      metaDesc: 'Akut veterinärvård i Vasa vardagar 9–17. Ring (06) 321 7300 före besöket — vi gör plats för brådskande fall. Förstahjälp och anvisningar vid nödsituationer.',
      sections: [
        { heading: 'Akut vård vardagar 9–17', text: 'Djurklinik Saari är öppen vardagar kl. 9–17. I akuta situationer strävar vi alltid efter att göra plats för brådskande fall samma dag — ring först (06) 321 7300, så kan vi bedöma situationen, ge förstahjälpsråd för resan och förbereda mottagningen. En oannonserad ankomst utan telefonkontakt kan leda till lång väntetid om de bokade patienterna är samtidigt på mottagningen. Vasaregionen saknar separat djurakutmottagning kvällar och helger, men under vardagar är akut vård bara ett telefonsamtal bort.' },
        { heading: 'När ringa direkt', text: 'Följande symtom är alltid skäl att kontakta veterinär utan dröjsmål: <strong>andningssvårigheter</strong> (flämtning, blåaktiga tandkött, andning genom munnen hos katt), <strong>medvetslöshet eller kramper</strong>, <strong>kraftig blödning eller större sår</strong>, <strong>trafikolycka, fall eller annat allvarligt trauma</strong>, <strong>katt som inte kan urinera</strong> (urinrörsstopp är livshotande inom timmar), <strong>hund med uppsvälld buk och resultatlösa kräkningar</strong> (magomvridning är livshotande), <strong>intag av giftiga ämnen</strong> (choklad, xylitol, frostskyddsmedel, vindruvor, lök, humanläkemedel), <strong>huggormsbett</strong> (Finlands enda giftiga orm — kräver alltid veterinärbedömning), <strong>kraftiga kräkningar eller diarré över ett dygn</strong>, <strong>ögonskada eller plötslig blindhet</strong>, <strong>okontrollerad smärta</strong>, <strong>dräktig tik som är i förlossning över en halvtimme utan framsteg</strong>.' },
        { heading: 'Hur agera i nödsituation', text: '<strong>1. Ring först (06) 321 7300.</strong> Vi förbereder oss och ger förstahjälpsråd för resan. <strong>2. Håll djuret varmt och lugnt.</strong> Vid transport av traumapatienter, använd ett plant underlag — filt eller låg låda — att lyfta upp i armarna kan förvärra rygg- eller ledskador. <strong>3. Vid misstänkt förgiftning, ta med förpackningen eller ett prov</strong> av spyan. Försök inte framkalla kräkning hemma utan telefonkonsultation — vid vissa förgiftningar (frätande ämnen, vassa föremål) är det farligt. <strong>4. Ge inte humanläkemedel.</strong> Paracetamol är livshotande för katt, ibuprofen skadar hundens mag-tarmkanal och njurar. <strong>5. Känn igen chocktecken:</strong> kalla öron och tassar, blekt tandkött, snabb ytlig andning, slöhet — chock kräver omedelbar vätskebehandling.' },
        { heading: 'Kvällar och helger', text: 'Djurklinik Saari är inte en 24/7-jourmottagning, och Vasaregionen saknar dygnetruntöppen smådjursjour. Kvällar (efter kl. 17) och helger ligger de närmaste nattjourerna i Tammerfors och Helsingfors, cirka 3–4 timmars körväg bort. Vid livshotande situationer rekommenderar vi att först ringa vald 24/7-klinik för att bekräfta att de tar emot er och få förstahjälpsråd för den långa resan. Du kan också ringa oss — även om vi inte är öppna, hör vi telefonsvararen direkt på morgonen och ordnar vid behov morgonens första tid.' },
        { heading: 'Vanligaste nödsituationer och bakgrund', text: 'Vi har samlat mer information om några av de vanligaste nödsituationerna på våra sidor. Läs vid behov mer: <a href="/sv/artiklar/huggormsbett.html">huggormsbett — behandling och förstahjälp</a>, <a href="/sv/artiklar/livmoderinflammation.html">livmoderinflammation (pyometra)</a> och <a href="/sv/artiklar/diarre.html">akut diarré hos hund och katt</a>. Att känna igen situationen i tid förbättrar behandlingsresultatet avsevärt.' },
        { heading: 'Vanliga frågor om jouren', text: '<strong>Kan jag komma utan tidsbokning vid en akut situation?</strong> Vid akuta nödsituationer tar vi emot patienter vardagar 9–17 även utan tidsbokning — men ring alltid först (06) 321 7300. Då kan vi förbereda plats och ge förstahjälpsråd per telefon. <strong>Vilken är närmaste 24/7-djurjour?</strong> De närmaste dygnetruntöppna smådjursjourerna ligger i Tammerfors och Helsingfors, cirka 3–4 timmars körväg från Vasa. Vid livshotande situationer, ring först vald jour — du får förstahjälpsråd för resan.' },
      ],
      ctaTitle: 'Ring oss',
    ...
    en: {
      ...
      metaDesc: 'Urgent veterinary care in Vaasa, weekdays 9–17. Call (06) 321 7300 first — we make room for emergencies. First aid guidance and what to do in critical situations.',
      sections: [
        { heading: 'Urgent care weekdays 9–17', text: 'Saari Animal Clinic is open Monday to Friday, 9–17. In acute situations we always try to make room for urgent cases the same day — call (06) 321 7300 first so we can assess the situation, give first-aid guidance for the journey, and prepare for your arrival. Arriving unannounced may lead to a long wait if scheduled patients are with us at the same time. The Vaasa region has no separate after-hours veterinary emergency service, but during weekday hours, urgent care is one phone call away.' },
        { heading: 'When to call immediately', text: 'The following symptoms always warrant contacting a veterinarian without delay: <strong>breathing difficulty</strong> (open-mouth panting, blue gums, mouth-breathing in cats), <strong>unconsciousness or seizures</strong>, <strong>heavy bleeding or a large wound</strong>, <strong>traffic accident, fall, or other serious trauma</strong>, <strong>a cat unable to urinate</strong> (urinary blockage is life-threatening within hours), <strong>a dog with a swollen abdomen attempting to vomit unsuccessfully</strong> (gastric torsion is life-threatening), <strong>ingestion of toxic substances</strong> (chocolate, xylitol, antifreeze, grapes, onion, human medications), <strong>adder bite</strong> (Finland\'s only venomous snake — always requires veterinary assessment), <strong>severe vomiting or diarrhoea lasting over 24 hours</strong>, <strong>eye injury or sudden blindness</strong>, <strong>uncontrolled pain</strong>, <strong>a pregnant female in labour for over 30 minutes without progress</strong>.' },
        { heading: 'What to do in an emergency', text: '<strong>1. Call first: (06) 321 7300.</strong> We can prepare and give first-aid advice for the journey. <strong>2. Keep your pet warm and calm.</strong> When transporting trauma patients, use a flat surface — a blanket or shallow box — lifting in your arms can worsen spinal or joint injuries. <strong>3. With suspected poisoning, bring the packaging or a sample</strong> of any vomit. Do not attempt to induce vomiting at home without consulting us first — in some poisonings (corrosive substances, sharp objects) it is dangerous. <strong>4. Do not give human medications.</strong> Paracetamol is fatal to cats, ibuprofen damages a dog\'s gastrointestinal tract and kidneys. <strong>5. Recognise shock:</strong> cold ears and paws, pale gums, rapid shallow breathing, lethargy — shock requires immediate fluid therapy.' },
        { heading: 'Evenings and weekends', text: 'Saari Animal Clinic is not a 24/7 emergency facility, and the Vaasa region has no after-hours small-animal emergency service. In the evenings (after 17:00) and on weekends, the nearest 24/7 emergency clinics are in Tampere and Helsinki, approximately 3–4 hours\' drive away. For life-threatening situations we recommend calling your chosen 24/7 clinic first to confirm they can take you and to receive first-aid guidance for the long journey. You can also call us — even when closed, we check voicemail first thing in the morning and arrange the first available appointment when needed.' },
        { heading: 'Most common emergencies and background', text: 'We have collected detailed information about some of the most common emergencies on our site. Read more as needed: <a href="/en/articles/snake-bite.html">adder bite — treatment and first aid</a>, <a href="/en/articles/pyometra.html">pyometra (uterine infection)</a> and <a href="/en/articles/diarrhoea.html">acute diarrhoea in dogs and cats</a>. Recognising the situation early significantly improves treatment outcomes.' },
        { heading: 'Frequently asked questions about emergencies', text: '<strong>Can I come without an appointment in an emergency?</strong> In acute emergencies we accept patients weekdays 9–17 even without an appointment — but always call (06) 321 7300 first. This lets us prepare space and give first-aid advice over the phone. <strong>Where is the nearest 24/7 veterinary emergency?</strong> The nearest 24/7 small-animal emergency clinics are in Tampere and Helsinki, about 3–4 hours\' drive from Vaasa. In life-threatening situations, call your chosen emergency clinic first — you will receive first-aid guidance for the journey.' },
      ],
      ctaTitle: 'Call us',
    ...
    faq: [
      { q: 'Voinko tulla ilman ajanvarausta hätätilanteessa?', a: 'Kyllä — akuuteissa hätätilanteissa otamme potilaita arkisin 9–17 ilman ajanvarausta, mutta soita aina ensin numeroon (06) 321 7300. Näin voimme arvioida tilanteen ja antaa ensiapuohjeita matkan ajaksi.' },
      { q: 'Mikä on lähin 24/7 eläinpäivystys?', a: 'Lähimmät ympärivuorokautiset pieneläinpäivystykset sijaitsevat Tampereella ja Helsingissä, noin 3–4 tunnin ajomatkan päässä Vaasasta. Vaasan seudulla ei ole erillistä yöpäivystystä — Eläinklinikka Saari on auki arkisin klo 9–17.' },
      { q: 'Mitä teen, jos lemmikkini on syönyt jotain myrkyllistä?', a: 'Soita välittömästi numeroon (06) 321 7300 ja kerro mitä lemmikki on syönyt, kuinka paljon ja milloin. Ota mukaan pakkaus tai näyte. Älä yritä oksennuttaa kotona ilman puhelinneuvottelua — joissakin myrkytyksissä se on vaarallista.' },
      { q: 'Kuinka tunnistan sokin?', a: 'Sokin oireita ovat kylmät korvat ja tassut, vaaleat ikenet, nopea pinnallinen hengitys ja äkillinen väsähtäminen. Sokki on aina hengenvaarallinen ja vaatii välitöntä nestehoitoa eläinlääkärin valvonnassa — soita meille heti.' },
      { q: 'Onko hätäkäynnistä lisämaksu?', a: 'Akuuttikäynti maksaa saman kuin tavanomainen vastaanottokäynti. Tutkimuksista ja hoidoista veloitetaan hinnaston mukaisesti — saat aina kustannusarvion ennen hoitojen aloittamista.' },
      { q: 'Voinko soittaa myös iltaisin tai viikonloppuna?', a: 'Voit — vaikka emme ole avoinna, kuuntelemme vastaajaviestit heti aamulla ja järjestämme tarvittaessa ensimmäisen ajan. Hengenvaarallisissa tilanteissa soita ensin lähimpään 24/7 päivystykseen (Tampere tai Helsinki).' },
    ]
  },
];
