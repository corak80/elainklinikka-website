...
const servicePages = [
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'Milloin se on hätätilanne?', text: '<ul class="emergency-symptoms"><li><strong>Voimakas läähätys tai hengenahdistus</strong> — sinerrät tai vaaleat limakalvot, kissan hengittäminen avoimin suin (kissalla harvinainen, aina hätämerkki). Tavallinen läähätys kuumalla tai jännityksen jälkeen ei ole sama asia.</li><li><strong>Tajuttomuus tai krampit</strong></li><li><strong>Voimakas verenvuoto tai laaja haava</strong></li><li><strong>Liikennevahinko, putoaminen tai muu vakava trauma</strong></li><li><strong>Virtsaamisvaikeudet tai virtsaamisen estyminen</strong> — kiireellisimmillään urokskissalla: virtsaputken tukos on hengenvaarallinen jo tuntien sisällä, soita heti. Myös koirilla aito hätätilanne (virtsakivet, eturauhassairaudet). Mikä tahansa lemmikki, joka ponnistaa toistuvasti saamatta virtsaa tulemaan, tarvitsee välittömän arvion.</li><li><strong>Koira, jolla on turvonnut vatsa ja joka yrittää oksentaa tuloksetta</strong> — mahalaukun kiertymä on hengenvaarallinen</li><li><strong>Myrkyllisen aineen nauttiminen</strong> — suklaa, ksylitoli, jäänestoaine (etyleeniglykoli), viinirypäleet, sipuli, ihmislääkkeet</li><li><strong>Kyynpurema</strong> — Suomen ainoa luonnonvarainen myrkkykäärme. Kanna lemmikki, älä anna sen kävellä. Tarvitsee aina eläinlääkärin arvion.</li><li><strong>Voimakas oksentelu tai ripuli yli vuorokauden</strong> — pennuilla, kissanpennuilla, vanhuksilla ja pieniroduilla nopeammin. Verinen oksennus tai uloste vaatii välittömän arvion.</li><li><strong>Silmävamma tai äkillinen sokeus</strong></li><li><strong>Hallitsematon kipu</strong></li><li><strong>Tiine narttu, joka ponnistaa voimakkaasti yli 30 minuuttia ilman pentua</strong>, tai jolla on yli 2 tunnin tauko pentujen välillä, tai jolla on vihertävää tai veristä vuotoa ilman pentua</li></ul>' },
      { heading: 'Miten toimit hätätilanteessa', text: '<ol class="emergency-steps"><li><strong>Soita ensin.</strong> Virka-aikana (06) 321 7300, virka-ajan ulkopuolella alueen päivystysnumero 0600 399 299 (katso seuraava osio). Näin ehdimme valmistautua ja voimme antaa ensiapuohjeita matkan ajaksi.</li><li><strong>Pidä lemmikki lämpimänä ja rauhallisena.</strong> Kuljeta loukkaantunutta lemmikkiä tasaisella alustalla. Suurille koirille käytä lautaa, auton tavaratilan pohjaa tai jämäkkää pahvilaatikkoa; kissoille ja pikkukoirille kantokoria. Tue päätä ja takapäätä samanaikaisesti. Syliin nostaminen voi pahentaa selkä- tai nivelvammoja.</li><li><strong>Myrkytysepäilyssä ota mukaan pakkaus tai näyte.</strong> Älä yritä oksennuttaa kotona ilman, että olet ensin soittanut meille — joissakin myrkytyksissä (syövyttävät aineet, terävät esineet) se on vaarallista. Älä koskaan käytä suolaa oksennuttamiseen — se on hengenvaarallista erityisesti kissalle.</li><li><strong>Älä anna ihmislääkkeitä.</strong> Parasetamoli on kissalle tappavaa ja koiralle myrkyllistä väärässä annoksessa. Ibuprofeeni, diklofenaakki ja aspiriini vaurioittavat ruoansulatuskanavaa ja munuaisia molemmilla.</li><li><strong>Tunnista sokin oireet:</strong> kylmät korvat ja tassut, vaaleat ikenet, nopea pinnallinen hengitys, äkillinen voimattomuus. Peittele lemmikki, älä juota, lähde heti matkaan ja soita matkalla — sokki vaatii välitöntä nestehoitoa eläinlääkärin valvonnassa.</li></ol>' },
      { heading: 'Iltaisin ja viikonloppuisin — Pohjoinen päivystysalue', text: '<p>Eläinklinikka Saari on suljettu iltaisin ja viikonloppuisin, emmekä vastaa puhelimeen virka-ajan ulkopuolella. Vaasan alueelle — kattaen <strong>Vaasan, Mustasaaren, Laihian, Vähänkyrön ja Vöyrin</strong> — on yhteinen päivystysnumero ilta-, yö- ja viikonloppuaikoihin.</p><aside class="emergency-card" role="note"><div class="emergency-card-label">Alueen päivystysnumero</div><a class="emergency-card-number" href="tel:+358600399299">0600&nbsp;399&nbsp;299</a><div class="emergency-card-hours"><span>Arki-iltaisin 16.00 – 08.00</span><span>Viikonloput pe 16.00 – ma 08.00</span></div><div class="emergency-card-coverage">Vaasa · Mustasaari · Laihia · Vähäkyrö · Vöyri</div></aside><p>Päivystävä eläinlääkäri arvioi tilanteen puhelimessa ja ohjaa oikeaan paikkaan. Puhelumaksu noudattaa alueen päivystystaksaa (noin 1,53 €/min päiväsaikaan, 3,55 €/min yöllä klo 22–08). Käynti- ja toimenpidemaksuihin lisätään päivystyskorotus alueen ohjeistuksen mukaan — tarkka summa selviää puhelussa.</p><div class="emergency-hospital"><strong>Laajempaa aukiolopaikkaa tarvitseville</strong><div class="hospital-meta"><strong>Evidensia Seinäjoen Eläinsairaala</strong> · Ravitie 8 B, Seinäjoki · noin 1 t 15 min Vaasasta · ma–la 8–21, su 9.30–18 · triage 0600 41 8823. Käytännössä lähin valinta iltakäynneille klo 21 asti.</div></div><div class="emergency-hospital"><strong>24/7 sairaalahoitoa (yöpyminen sairaalassa)</strong><div class="hospital-meta"><strong>Eläinklinikka Syke (Evidensia)</strong> · Itäkeskuksenkaari 8, Pori · noin 2 tuntia, ~195 km<br><strong>Eläinsairaala Veter (Evidensia)</strong> · Peltokatu 16, Tampere · noin 3 tuntia (seuraava 24/7-vaihtoehto Porin jälkeen). Soita aina ensin vahvistaaksesi, että teidät otetaan vastaan.</div></div>' },
