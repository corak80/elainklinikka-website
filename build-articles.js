...
const servicePages = [
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: "Matkustaminen EU:n sisällä", text: "EU:n sisällä riittää voimassa oleva EU-lemmikkipassi, mikrosiru ja passiin merkitty rabiesrokotus, joka on annettu vähintään 21 päivää ennen matkaa. Koirilla on lisäksi ekinokokkilääkitys (heisimatolääkitys), jonka eläinlääkäri antaa ja kirjaa passiin: Suomeen palattaessa esimerkiksi Ruotsista koira on lääkittävä 1–5 päivää (24–120 tuntia) ennen saapumista. Usein matkustavalle koiralle vaihtoehto on Ruokaviraston 28 päivän sääntö: koira lääkitään ennen matkaa vähintään kahdesti, käsittelyjen välillä 1–28 päivää, ja sen jälkeen säännöllisesti enintään 28 päivän välein – silloin se voi ylittää rajan vapaasti. Lääkitystä ei vaadita, kun koira tulee Suomeen suoraan Norjasta, Irlannista tai Maltalta. Suomi on ekinokokkivapaa, joten suoraan Suomesta Norjaan tai Iso-Britanniaan matkustava koira ei tarvitse lääkitystä – Ruotsin kautta Norjaan mentäessä lääkitys 1–5 päivää ennen rajaa tai 28 päivän sääntö vaaditaan, ja Iso-Britannia ei hyväksy 28 päivän sääntöä lainkaan." },
    ...
    en: {
      ...
      sections: [
        ...
        { heading: "Travelling within the EU", text: "Within the EU you need a valid EU pet passport, a microchip and a rabies vaccination recorded in the passport, given at least 21 days before travel. Dogs additionally need a tapeworm (echinococcus) treatment given and recorded in the passport by a vet: when returning to Finland from Sweden, for example, the dog must be treated 1–5 days (24–120 hours) before arrival. For dogs that travel often, the Finnish Food Authority's 28-day rule is an alternative: the dog is treated at least twice before travel, 1–28 days apart, and then regularly at intervals of no more than 28 days – after which it can cross the border freely. No treatment is needed when a dog enters Finland directly from Norway, Ireland or Malta. Finland is echinococcus-free, so a dog travelling directly from Finland to Norway or Great Britain needs no treatment – entering Norway via Sweden requires treatment 1–5 days before the border or the 28-day rule, and Great Britain does not accept the 28-day rule at all." },
