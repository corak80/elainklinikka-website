...
const servicePages = [
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'Toimenpide klinikallamme', text: 'Sterilisaatio tehdään inhalaatioanestesiassa kattavalla kivunlievityksellä. Valvomme potilasta jatkuvasti koko toimenpiteen ajan: sydämen syke, verenpaine, happisaturaatio ja lämpötila. Käytämme moderneja, kudoksia säästäviä leikkaustekniikoita ja tarkkaa hemostasiaa. Potilas kotiutuu yleensä samana päivänä ja saa mukaansa kipulääkityksen sekä haavasuojan tai kaulurin.' },
      { heading: 'Oikea ajoitus', text: 'Optimaalinen sterilisaatioikä riippuu lajista, rodusta ja koosta. Naaraskissat sterilisoidaan yleensä noin 5–6 kuukauden iässä — usein ennen ensimmäistä juoksuaikaa, jolloin nisäkasvainten ennaltaehkäisy on tehokkainta. Pienillä koiraroduilla sterilisaatio voidaan tehdä noin 6–12 kuukauden iässä, suurilla roduilla suositellaan odottamista 12–18 kuukauden ikään luuston kasvun varmistamiseksi. Eläinlääkäri arvioi parhaan ajankohdan yksilöllisesti.' },
    ...
    sv: {
      ...
      sections: [
        { heading: 'Varför sterilisera ett hondjur?', text: 'Vid sterilisering avlägsnas äggstockarna (ovariektomi) eller äggstockarna och livmodern (ovariohysterektomi). Ingreppet eliminerar hormonella sjukdomar helt och förebygger effektivt livmoderinflammation (pyometra) samt bröstcancer — särskilt om steriliseringen utförs före första löpet. Sterilisering lugnar också löpbeteendet och förhindrar oönskade dräktigheter. Hos honkaniner är sterilisering ofta även medicinskt motiverad eftersom risken för livmodercancer ökar med åldern.' },
        { heading: 'Ingreppet på vår klinik', text: 'Sterilisering utförs under inhalationsanestesi med omfattande smärtlindring. Vi övervakar patienten kontinuerligt under hela ingreppet: hjärtfrekvens, blodtryck, syremättnad och temperatur. Vi använder moderna, vävnadssparande operationstekniker och noggrann hemostas. Patienten skrivs vanligen ut samma dag och får med sig smärtstillande medicin samt skyddsdräkt eller krage.' },
        { heading: 'Rätt tidpunkt', text: 'Optimal ålder för sterilisering beror på art, ras och storlek. Honkatter steriliseras vanligen vid cirka 5–6 månaders ålder — gärna före första löpet, då förebyggande av bröstcancer är mest effektivt. Hos små hundraser kan sterilisering göras vid cirka 6–12 månaders ålder, hos stora raser rekommenderas att vänta till 12–18 månaders ålder för att säkerställa skelettets tillväxt. Veterinären bedömer den bästa tidpunkten individuellt.' },
        { heading: 'Vanliga frågor om sterilisering', text: '<strong>Vid vilken ålder görs sterilisering?</strong> Honkatter steriliseras vanligen vid cirka 5–6 månaders ålder. Små hundraser vid 6–12 månader, stora raser vid 12–18 månader. Honkaniner steriliseras vanligen vid 6–12 månaders ålder. <strong>Hur lång är återhämtningsperioden?</strong> Efter sterilisering behöver husdjuret vila i cirka 10–14 dagar. Under denna tid bör man undvika hoppande, springande och vild lek. Smärtstillande medicin ges med hem och såret skyddas med body eller krage. Stygnen tas bort eller löses upp själva efter cirka 10 dagar. De flesta patienter återhämtar sig snabbt och återgår till normal vardag inom en vecka. <strong>Och kastrering av handjur?</strong> Information om kastrering av hanhundar, -katter och -kaniner finns på vår separata <a href="/sv/tjanster/kastrering/">kastreringssida</a>.' },
      ],
      ctaTitle: 'Boka tid',
      ctaText: 'Ring oss eller boka tid online.',
      ctaCall: 'Ring (06) 321 7300',
      ...
      relatedTitle: 'Relaterade artiklar',
      faq: [
        { q: 'Vad kostar honkattens sterilisering?', a: 'Honkattens sterilisering kostar 208 €. Hondhundens sterilisering kostar 483–753 € beroende på storlek. Honkaninens sterilisering 363 €. Priset inkluderar inhalationsanestesi, operationen, läkemedel, smärtstillande medicin för hemmet samt skyddsdräkt eller krage.' },
        { q: 'I vilken ålder utförs steriliseringen?', a: 'Honkatter steriliseras vanligen vid cirka 5–6 månaders ålder. Små hundraser vid 6–12 månader, stora raser vid 12–18 månader. Veterinären bedömer den bästa tidpunkten individuellt.' },
        { q: 'Hur lång är återhämtningstiden?', a: 'Efter sterilisering behöver husdjuret cirka 10–14 dagars vila. Smärtlindring skickas med hem och såret skyddas med skyddsdräkt eller krage. De flesta patienter återhämtar sig snabbt.' }
      ],
    },
    en: {
      ...
      relatedTitle: 'Related articles',
      faq: [
        { q: 'How much does spaying a female cat cost?', a: 'Spaying a female cat costs €208. Spaying a female dog costs €483–753 depending on size. Spaying a female rabbit €363. The price includes inhalation anaesthesia, the surgery, medications, take-home pain relief and a recovery suit or cone.' },
        { q: 'At what age is the surgery done?', a: 'Female cats are usually spayed at around 5–6 months of age. Small dog breeds at 6–12 months, large breeds at 12–18 months. The veterinarian assesses the best timing individually.' },
        { q: 'How long is the recovery time?', a: 'After spaying, the pet needs about 10–14 days of rest. Pain medication is sent home and the wound is protected with a recovery suit or cone. Most patients recover quickly.' }
      ],
    },
    ...
    faq: [
      { q: 'Paljonko naaraskissan sterilisaatio maksaa?', a: 'Naaraskissan sterilisaatio maksaa 208 €. Naaraskoiran sterilisaatio maksaa kokonsa mukaan 483–753 €. Naaraskanin sterilisaatio 363 €. Hinta sisältää inhalaatioanestesian, leikkauksen, lääkkeet, kotiin annettavan kipulääkityksen sekä haavasuojan tai kaulurin.' },
      { q: 'Missä iässä sterilisaatio tehdään?', a: 'Naaraskissat sterilisoidaan yleensä noin 5–6 kuukauden iässä — usein ennen ensimmäistä juoksuaikaa. Pienillä koiraroduilla 6–12 kuukauden iässä, suurilla roduilla 12–18 kuukauden iässä. Eläinlääkäri arvioi parhaan ajankohdan yksilöllisesti.' },
      ...
      { q: 'Mistä löydän tietoa uroseläinten kastraatiosta?', a: 'Uroskoirien, -kissojen ja -kanien kastraatiosta on oma sivunsa: <a href="/palvelut/kastraatio/">/palvelut/kastraatio/</a>.' }
    ]
  },
  {
    slug: 'sisataudit',
